...
// ─── OPERATIONAL FRAMEWORK — same for ALL services ────────────────────────────
const frameworkSteps = [
  {
    num: '1',
    title: 'Audit & Diagnostic',
    desc: 'Digital twin mapping of existing supply chain nodes and bottlenecks.',
  },
  {
    num: '2',
    title: 'Strategy Design',
    desc: 'Agentic AI model configuration tailored to specific market volatility.',
  },
  {
    num: '3',
    title: 'Cloud Integration',
    desc: 'Seamless API connection with ERP, WMS, and TMS systems.',
  },
  {
    num: '4',
    title: 'Continuous Loop',
    desc: 'Autonomous optimization and real-time risk mitigation.',
  },
];
...
const HeroSection = ({ service }) => {
  ...
  // Build headline — highlight the blue word(s)
  const renderTitle = () =>
    service.heroTitle.map((line, i) => {
      ...
      // check if blue word is embedded within the line
...
const PillarsSection = ({ service }) => {
  ...
  const tabs = ['Overview', 'Technical Specs'];

  // Auto grid columns: 2 cols for ≤4 cards, 3 cols for 5+
        ...
        >
          <div className="max-w-lg">
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-5xl mb-4" style={{ color: 'var(--color-text-heading)' }}>
              Core{' '}
              <span className="text-blue-gradient">Service Pillars</span>
            </h2>
          ...
          {/* Tabs */}
          {/* <div
            className="flex items-center rounded-full p-1 shrink-0 self-start"
            style={{
              background: isDark ? 'rgba(24,28,42,0.8)' : 'rgba(61,126,255,0.06)',
              border: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(61,126,255,0.18)',
            }}
          >
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className="px-4 py-2 rounded-full text-xs font-display font-semibold transition-all duration-250"
                  style={{
                    background: isActive ? '#3d7eff' : 'transparent',
                    color:      isActive ? '#ffffff' : 'var(--color-muted)',
                    boxShadow:  isActive ? '0 0 12px rgba(61,126,255,0.35)' : 'none',
                  }}
                >
                  {tab}
                </button>
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl lg:text-5xl mb-4" style={{ color: 'var(--color-text-heading)' }}>
            The Acespire{' '}
            <span className="text-blue-gradient">Operational Framework</span>
          </h2>
    ...
    >
      ...
      <div
        ...
        style={{
          background: hovered
            ? '#3d7eff'
            : isDark ? 'rgba(24,28,42,0.95)' : '#ffffff',
          border: `2px solid ${hovered ? '#3d7eff' : isDark ? 'rgba(61,126,255,0.35)' : 'rgba(61,126,255,0.35)'}`,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Let's build a tailored solution for your unique challenges. Book a free discovery call today.
            </p>
            <div
